<template>
  <div class="relative bg-white overflow-hidden min-h-screen lg:bg-gray-300">
    <div class="mx-auto">
      <div class="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:w-1/2 h-screen lg:pb-28 xl:pb-32">
