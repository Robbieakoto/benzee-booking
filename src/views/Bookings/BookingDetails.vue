<template>
  <dashboard-layout>
      ...
      <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <div class="flex-1 min-w-0">
            ...
            <div class="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap">
                ...
                <div class="mt-2 flex items-center text-sm leading-5 text-gray-500 mr-6">
           ...
           <div v-if="!$apollo.queries.booking.loading && !bookingDetails.is_available" class="mt-5 flex flex-wrap lg:mt-0 lg:ml-4"> 
    ...
    <template v-slot:content>
      ...
      <div v-if="bookingDetails.is_available && bookingDetails.is_paid" class="my-4 mx-4 md:flex transform transition duration-150 ease-in-out" aria-labelledby="modal-headline">
