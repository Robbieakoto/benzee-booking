        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap">
            <div class="mt-2 flex items-center text-sm leading-5 text-gray-500 sm:mr-6">
              ...
              {{rooms[0].room_type.amount_9_months_duration}} &ndash; {{rooms[0].room_type.amount_12_months_duration}}
            </div>
        ...
        <div>
          <dl>
            ...
            <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <dd class="mt-1 text-sm leading-5 font-medium text-gray-900 sm:mt-0 sm:col-span-2">
                {{rooms[0].room_type.number_of_occupants}}
            </dd>
            </div>
            <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt class="text-sm leading-5 font-medium text-gray-500">
...
export default {
  ...
  computed:{
    // roomLastUpdated(){
    //   return moment(this.rooms.last_updated).format("MMMM DD YYYY")
    // },
    roomCreatedAt(){
