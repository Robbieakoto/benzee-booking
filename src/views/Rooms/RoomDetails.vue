<template>
  <dashboard-layout>
      ...
      <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 lg:flex lg:items-center lg:justify-between">
        <div class="flex-1 min-w-0">
          ...
          <div class="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap">
            <div v-if="!$apollo.queries.rooms.loading" class="mt-2 flex items-center text-sm leading-5 text-gray-500 sm:mr-6">
    ...
    <template v-slot:content>
      <div v-if="!$apollo.queries.rooms.loading" class="bg-white shadow overflow-hidden sm:rounded-lg">
...
export default {
  ...
  computed:{
    roomDetails(){
      if (this.$apollo.queries.rooms.loading) return {}
      return this.rooms[0]
    },
    roomCreatedAt(){
      return moment(this.rooms.created_at).format("MMMM DD YYYY")
    },
    roomRangePrice(){
      return moment(this.rooms.amount_12_months_duration)
    }
}
};
</script>